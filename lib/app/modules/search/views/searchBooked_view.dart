...
class SearchBookedView extends GetView<SearchingController>{
  const SearchBookedView({super.key});
  @override
...
class ScrOpBooked extends StatelessWidget {
  const ScrOpBooked({super.key});
